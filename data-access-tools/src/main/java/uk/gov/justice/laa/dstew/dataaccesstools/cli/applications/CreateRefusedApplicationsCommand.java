...
@CommandLine.Command(name = "create-refused", description = "Create refused applications.")
public final class CreateRefusedApplicationsCommand implements Callable<Integer> {
  ...
  public Integer call() {
    ...
    return applications
        .root()
        .print(workflow.create(count, DecisionRequestFactory.Decision.REFUSED));
  }
}
