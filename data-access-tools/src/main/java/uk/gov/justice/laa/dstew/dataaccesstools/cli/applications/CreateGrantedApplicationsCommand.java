...
@CommandLine.Command(name = "create-granted", description = "Create granted applications.")
public final class CreateGrantedApplicationsCommand implements Callable<Integer> {
  ...
  public Integer call() {
    ...
    return applications
        .root()
        .print(workflow.create(count, DecisionRequestFactory.Decision.GRANTED));
  }
}
