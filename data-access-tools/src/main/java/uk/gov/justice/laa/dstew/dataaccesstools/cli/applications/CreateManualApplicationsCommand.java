...
@CommandLine.Command(
    ...
    description = "Create applications awaiting a manual decision.")
public final class CreateManualApplicationsCommand implements Callable<Integer> {
  ...
  public Integer call() {
    ...
    return applications.root().print(workflow.createManual(count));
  }
}
