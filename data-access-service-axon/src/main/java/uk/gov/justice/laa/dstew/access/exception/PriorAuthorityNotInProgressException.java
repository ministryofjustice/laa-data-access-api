...
/** Thrown when a submit or draft-save command targets a Prior Authority that is not IN_PROGRESS. */
...
public class PriorAuthorityNotInProgressException extends RuntimeException {
  ...
  public PriorAuthorityNotInProgressException(UUID submissionId) {
    super("Prior Authority " + submissionId + " is not in the IN_PROGRESS state");
