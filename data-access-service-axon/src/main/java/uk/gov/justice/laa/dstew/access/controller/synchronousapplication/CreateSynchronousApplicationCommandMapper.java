...
@Component
public class CreateSynchronousApplicationCommandMapper {

  private final ObjectMapper objectMapper;

  public CreateSynchronousApplicationCommandMapper(ObjectMapper objectMapper) {
    this.objectMapper = objectMapper;
  }

  /** Creates a command whose aggregate identifier is derived from the application content. */
  public CreateSynchronousApplicationCommand toCommand(
      ApplicationCreateRequest request, int schemaVersion) {
