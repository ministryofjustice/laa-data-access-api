...
public interface ApplicationRepository
  ...
  @Query(
      value =
          "SELECT la.lead_application_id FROM linked_applications la WHERE la.associated_application_id IN :pageIds",
      nativeQuery = true)
  ...
  @Query(
      ...
      nativeQuery = true)
  List<LinkedApplicationSummaryDto> findAllLinkedApplicationsByLeadIds(
