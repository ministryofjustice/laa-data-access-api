...
/**
 * V2 proceeding entity — no applicationId UUID column (owned by ApplicationEntityV2
 * via @JoinColumn); owns meritsDecision via merits_decision_id FK.
 */
...
public class ProceedingEntityV2 implements AuditableEntity {
