...
public class CaseworkerUnassignRequestGenerator
    extends BaseGenerator<CaseworkerUnassignRequest, CaseworkerUnassignRequest.Builder> {
  ...
  public CaseworkerUnassignRequest createDefault() {
    return CaseworkerUnassignRequest.builder()
        .eventHistory(
            EventHistoryRequest.builder().eventDescription("Testing unassignment").build())
        .build();
  }
}
