...
public class ApplicationMeritsGenerator
  ...
  public ApplicationMerits createRandom() {
    ...
    for (int i = 0; i < childrenCount; i++) {
      children.add(
          Map.of(
              ...
              "date_of_birth",
                  faker.timeAndDate().past(6570, java.util.concurrent.TimeUnit.DAYS).toString()));
    }
    ...
    return ApplicationMerits.builder().opponents(opponents).involvedChildren(children).build();
  }
}
