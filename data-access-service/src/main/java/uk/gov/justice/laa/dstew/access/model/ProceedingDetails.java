...
public record ProceedingDetails(
    ...
    UUID id,
    @JsonDeserialize(using = CategoryOfLawTypeDeserializer.class) CategoryOfLaw categoryOfLaw,
    @JsonDeserialize(using = MatterTypeDeserializer.class) MatterType matterType,
