...
public class IndividualsServiceTest extends BaseServiceTest {
  ...
  @Autowired private IndividualsService serviceUnderTest;
  ...
  public void givenIndividuals_whenGetIndividuals_thenReturnExtendedIndividuals() {
    ...
    IndividualEntity expectedIndividual =
        DataGenerator.createDefault(
            IndividualEntityGenerator.class, builder -> builder.id(UUID.randomUUID()));
    ...
    ApplicationEntity application =
        DataGenerator.createDefault(
            ApplicationEntityGenerator.class, builder -> builder.id(UUID.randomUUID()));
    setSecurityContext(TestConstants.Roles.CASEWORKER);

    when(individualRepository.findAll(any(Specification.class), any(Pageable.class)))
        .thenReturn(pageResult);
    when(applicationRepository.findById(application.getId())).thenReturn(Optional.of(application));

    // when
    List<IndividualResponse> actualIndividualResponses =
        serviceUnderTest
            .getIndividuals(
                1,
                10,
    ...
    assertExtendedIndividualEqual(
        expectedIndividuals.getFirst(),
  ...
  public void givenAppliedPreviouslyFalse_whenGetIndividuals_thenReturnAppliedPreviouslyFalse() {
    ...
    // when
    List<IndividualResponse> actualIndividuals =
        serviceUnderTest
            .getIndividuals(
                1,
                10,
  ...
  public void givenIndividuals_whenGetIndividuals_thenReturnIndividuals(int count) {
    // given
    List<IndividualEntity> expectedIndividuals =
        DataGenerator.createMultipleDefault(IndividualEntityGenerator.class, count);
    Page<IndividualEntity> pageResult = new PageImpl<>(expectedIndividuals);
    ...
    // when
    List<IndividualResponse> actualIndividualResponses =
        serviceUnderTest.getIndividuals(1, 10, null, null, null).page().stream().toList();
  ...
  public void givenDefaultPagination_whenGetIndividuals_thenReturnIndividuals() {
    // given
    List<IndividualEntity> expectedIndividuals =
        DataGenerator.createMultipleDefault(IndividualEntityGenerator.class, 5);
    Page<IndividualEntity> pageResult = new PageImpl<>(expectedIndividuals);
    ...
    // when
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(null, null, null, null, null);
  ...
  public void givenSecondPage_whenGetIndividuals_thenReturnIndividuals() {
    ...
    // when
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(2, 10, null, null, null);
  ...
  public void givenMaximumPageSize_whenGetIndividuals_thenReturnIndividuals() {
    ...
    // when
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(1, 100, null, null, null);
  ...
  public void noFilters_whenGetIndividuals_thenRepositoryFindAllWithSpecificationAndPageable() {
    ...
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(1, 10, null, null, null);

    verify(individualRepository, times(1)).findAll(any(Specification.class), any(Pageable.class));
    assertThat(result.page()).hasSize(1);
    assertThat(result.page().getContent().getFirst().getFirstName())
  ...
  @SuppressWarnings("unchecked")
  public void
      applicationIdProvided_whenGetIndividuals_thenRepositoryFindAllWithSpecificationAndPageable() {
    setSecurityContext(TestConstants.Roles.CASEWORKER);
    ...
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(1, 10, appId, null, null);
  ...
  @SuppressWarnings("unchecked")
  public void
      individualTypeProvided_whenGetIndividuals_thenRepositoryFindAllWithSpecificationAndPageable() {
    setSecurityContext(TestConstants.Roles.CASEWORKER);
    ...
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(1, 10, null, type, null);
  ...
  @SuppressWarnings("unchecked")
  public void
      bothFiltersProvided_whenGetIndividuals_thenRepositoryFindAllWithSpecificationAndPageable() {
    setSecurityContext(TestConstants.Roles.CASEWORKER);
    UUID appId = UUID.randomUUID();
    IndividualType type = IndividualType.CLIENT;
    IndividualEntity entity = DataGenerator.createDefault(IndividualEntityGenerator.class);
    ...
    PaginatedResult<IndividualResponse> result =
        serviceUnderTest.getIndividuals(1, 10, appId, type, null);
  ...
  private void assertIndividualListsEqual(
      List<IndividualResponse> actualList, List<IndividualEntity> expectedList) {
    ...
    for (IndividualEntity expected : expectedList) {
      ...
      assertThat(match).as("No matching Individual found for expected: " + expected).isTrue();
    }
  }
  ...
  private void assertExtendedIndividualEqual(
      IndividualEntity expected, IndividualResponse actual, ApplicationContent applicationContent) {
    assertIndividualEqual(expected, actual);
    ...
    var expectedAppliedPreviously =
        Optional.ofNullable(applicationContent.getApplicant())
        ...
        builder ->
            builder
                ...
                .applicationContent(
                    MapperUtil.getObjectMapper()
                        .convertValue(
                            ApplicationContent.builder().applicant(applicant).build(), Map.class)));
  }

  @SuppressWarnings("unchecked")
  private ApplicationEntity createApplicationWithAddresses(List<Map<String, Object>> addresses) {
    ApplicationApplicant applicant = ApplicationApplicant.builder().addresses(addresses).build();
    return DataGenerator.createDefault(
        ApplicationEntityGenerator.class,
        builder ->
            builder
