...
public class ApplicationServiceV2Test extends BaseServiceTest {
  ...
  class GetApplication {
    ...
    @Test
    public void
        givenApplicationEntityAndRoleReader_whenGetApplication_thenReturnMappedApplication() {
      // given
    ...
    @Test
    public void
        givenApplicationAndNotRoleReader_whenGetApplication_thenThrowUnauthorizedException() {
    ...
    public void assertApplicationEqual(
        ApplicationEntity expectedApplication, Application actualApplication) {
      ...
      assertIndividualCollectionsEqual(
          actualApplication.getIndividuals(), expectedApplication.getIndividuals());
    }
  }
  ...
  class CreateApplication {
    ...
    public void givenNewApplication_whenCreateApplication_thenReturnNewId()
      ...
      ApplicationEntity withExpectedId =
          applicationEntityFactory.createDefault(builder -> builder.id(expectedId));

      ApplicationCreateRequest applicationCreateRequest =
          applicationCreateRequestFactory.createDefault();
    ...
    void mapToApplicationEntity_SuccessfullyMapFromApplicationContentFields(
      ...
      assertAll(
          () ->
              assertEquals(
                  expectedUseDelegatedFunctions, actualApplicationEntity.isUseDelegatedFunctions()),
    ...
    @Test
    public void
        givenNewApplicationAndNoRole_whenCreateApplication_thenThrowUnauthorizedException() {
    ...
    public void
        GivenInvalidApplicationAndRoleWriter_whenCreateApplication_thenValidationExceptionWithCorrectMessage(
            ApplicationCreateRequest applicationCreateRequest,
            ValidationException validationException) {
      setSecurityContext(TestConstants.Roles.WRITER);

      Throwable thrown =
          catchThrowable(() -> serviceUnderTest.createApplication(applicationCreateRequest));
      assertThat(thrown)
    ...
    private Stream<Arguments> invalidApplicationSpecificCases() {
      return Stream.of(
          ...
          Arguments.of(
              applicationCreateRequestFactory.createDefault(builder -> builder.status(null)),
              new ValidationException(List.of("Application status cannot be null"))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(builder -> builder.laaReference(null)),
              new ValidationException(List.of("Application reference cannot be blank"))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(builder -> builder.laaReference("")),
              new ValidationException(List.of("Application reference cannot be blank"))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder -> builder.applicationContent(new HashMap<>())),
              new ValidationException(List.of("Application content cannot be empty"))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.applicationContent(
                          applicationContentFactory.createDefaultAsMap(
                              detailsBuilder -> detailsBuilder.proceedings(null)))),
              ...
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.applicationContent(
                          applicationContentFactory.createDefaultAsMap(
                              detailsBuilder ->
                                  detailsBuilder.proceedings(
                                      List.of(
                                          proceedingDetailsFactory.createDefault(
                                              proceedingDetailsBuilder ->
                                                  proceedingDetailsBuilder.leadProceeding(
                                                      false))))))),
    ...
    private Stream<Arguments> invalidIndividualSpecificCases() {
      return Stream.of(
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder -> builder.individuals(Collections.singletonList(null))),
              new ValidationException(List.of("Individual cannot be null."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.firstName(null))))),
              new ValidationException(List.of("First name must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.firstName(""))))),
              new ValidationException(List.of("First name must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.lastName(null))))),
              new ValidationException(List.of("Last name must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.lastName(""))))),
              new ValidationException(List.of("Last name must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.details(null))))),
              new ValidationException(List.of("Individual details must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.details(new HashMap<>()))))),
              new ValidationException(List.of("Individual details must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createDefault(
                                  builderInd -> builderInd.dateOfBirth(null))))),
              new ValidationException(List.of("Date of birth must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
          ...
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createRandom(
                                  builderInd -> builderInd.firstName(null)),
                              individualFactory.createRandom(
                                  builderInd -> builderInd.lastName(null))))),
              new ValidationException(
                  List.of("First name must be populated.", "Last name must be populated."))),
          Arguments.of(
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.individuals(
                          List.of(
                              individualFactory.createRandom(
                                  builderInd -> builderInd.firstName(null).lastName(null)),
                              individualFactory.createRandom(
                                  builderInd -> builderInd.lastName(null).dateOfBirth(null))))),
              new ValidationException(
                  List.of(
                      "First name must be populated.",
                      "Last name must be populated.",
          ...
          Arguments.of(
              ...
              Arguments.of(
                  ...
                  Arguments.of(
                      ...
                      new ValidationException(
                          List.of("No proceedings found in application content")),
                      Arguments.of(
                          applicationCreateRequestFactory.createDefault(
                              builder ->
                                  builder.applicationContent(
    ...
    private Map<String, Object> getAppContentMap(
        boolean autoGrant, List<ProceedingJsonObject> proceedings, String appContentId) {
      String submittedAt = "2026-01-15T10:20:30Z";
      AppContentJsonObject applicationContent =
          AppContentJsonObject.builder()
      ...
      try {
        appContentMap =
            objectMapper.readValue(objectMapper.writeValueAsString(applicationContent), Map.class);
    ...
    private static ProceedingJsonObject getProceedingJsonObject(
        Boolean useDelegatedFunctions, boolean leadProceeding) {
              ...
              applicationCreateRequestFactory.createDefault(
                  builder ->
                      builder.applicationContent(
                          getAppContentMap(
                              false,
                              List.of(getProceedingJsonObject(true, true)),
                              UUID.randomUUID().toString()))),
              true,
              false),
          Arguments.of(
                  ...
                  builder ->
                      builder.applicationContent(
                          getAppContentMap(
                              true,
                              List.of(
                                  getProceedingJsonObject(false, true),
                                  getProceedingJsonObject(true, false)),
                              UUID.randomUUID().toString()))),
              true,
              true),
          Arguments.of(
                  ...
                  builder ->
                      builder.applicationContent(
                          getAppContentMap(
                              ...
                              List.of(
                                  getProceedingJsonObject(false, true),
                                  getProceedingJsonObject(false, false)),
                              UUID.randomUUID().toString()))),
              false,
              true));
    }

    private void verifyThatApplicationSaved(
        ApplicationCreateRequest applicationCreateRequest, int timesCalled) {
      ArgumentCaptor<ApplicationEntity> captor = ArgumentCaptor.forClass(ApplicationEntity.class);
      verify(applicationRepository, times(timesCalled)).save(captor.capture());
      ApplicationEntity actualApplicationEntity = captor.getValue();

      assertThat(actualApplicationEntity.getStatus())
          .isEqualTo(applicationCreateRequest.getStatus());
      assertThat(actualApplicationEntity.getLaaReference())
          .isEqualTo(applicationCreateRequest.getLaaReference());
      ...
      assertThat(actualApplicationEntity.getApplyApplicationId())
          .isEqualTo(applicationContentDetails.getApplyApplicationId());
      assertThat(actualApplicationEntity.isUseDelegatedFunctions())
          .isEqualTo(applicationContentDetails.getProceedings().get(0).useDelegatedFunctions());
      ...
      assertIndividualCollectionsEqual(
          applicationCreateRequest.getIndividuals(), actualApplicationEntity.getIndividuals());
    }

    private ApplicationContentDetails parseApplicationContentDetails(
    ...
    private void verifyThatCreateDomainEventSaved(
        DomainEventEntity expectedDomainEvent, int timesCalled) throws JsonProcessingException {
      ...
      Map<String, Object> actualData =
          objectMapper.readValue(actualDomainEvent.getData(), Map.class);
  ...
  class UpdateApplication {
    ...
    void givenNoApplication_whenUpdateApplication_thenThrowResourceNotFoundException() {
      ...
      assertThatExceptionOfType(ResourceNotFoundException.class)
          .isThrownBy(
              () ->
                  serviceUnderTest.updateApplication(applicationId, new ApplicationUpdateRequest()))
          .withMessageContaining("No application found with id: " + applicationId);
      verify(applicationRepository, times(1)).findById(applicationId);
      verify(domainEventRepository, never()).save(any());
    }
    ...
    void givenApplication_whenUpdateApplication_thenUpdateAndSave() throws JsonProcessingException {
      // given
      UUID applicationId = UUID.randomUUID();
      ApplicationEntity expectedEntity =
          applicationEntityFactory.createDefault(
              builder ->
                  builder
                      .id(applicationId)
                      .applicationContent(new HashMap<>(Map.of("test", "unmodified"))));
      ApplicationEntity updatedEntity =
          expectedEntity.toBuilder()
    ...
    void
        givenApplicationAndInvalidUpdateRequest_whenUpdateApplication_thenValidationExceptionWithCorrectMessage(
            UUID applicationId,
      ...
      Throwable thrown =
          catchThrowable(
              () -> serviceUnderTest.updateApplication(applicationId, applicationUpdateRequest));
      assertThat(thrown)
          .isInstanceOf(ValidationException.class)
          .usingRecursiveComparison()
          .isEqualTo(validationException);
    ...
    @Test
    public void
        givenApplicationUpdateAndNotRoleWriter_whenCreateApplication_thenThrowUnauthorizedException() {
      // given
      UUID applicationId = UUID.randomUUID();
    ...
    @Test
    public void
        givenApplicationUpdateAndNoRole_whenCreateApplication_thenThrowUnauthorizedException() {
      // given
      UUID applicationId = UUID.randomUUID();
    ...
    public final Stream<Arguments> invalidApplicationUpdateRequests() {
      return Stream.of(
          Arguments.of(
              UUID.randomUUID(),
              applicationUpdateRequestFactory.createDefault(
                  builder -> builder.applicationContent(null)),
              new ValidationException(
    ...
    private void verifyThatApplicationUpdated(
        ApplicationUpdateRequest applicationUpdateRequest, int timesCalled) {
      ArgumentCaptor<ApplicationEntity> captor = ArgumentCaptor.forClass(ApplicationEntity.class);
      verify(applicationRepository, times(timesCalled)).save(captor.capture());
      ApplicationEntity actualApplicationEntity = captor.getValue();

      assertThat(actualApplicationEntity.getStatus())
          .isEqualTo(applicationUpdateRequest.getStatus());
      assertThat(actualApplicationEntity.getApplicationContent())
          .usingRecursiveComparison()
          .ignoringCollectionOrder()
    ...
    private void verifyThatUpdateDomainEventSaved(
        DomainEventEntity expectedDomainEvent, int timesCalled) throws JsonProcessingException {
      ArgumentCaptor<DomainEventEntity> captor = ArgumentCaptor.forClass(DomainEventEntity.class);
      verify(domainEventRepository, times(timesCalled)).save(captor.capture());
      DomainEventEntity actualDomainEvent = captor.getValue();
  ...
  class AssignCaseworker {
    ...
    void givenCaseworkerAndApplications_whenAssignCaseworker_thenAssignAndSave(
      ...
      EventHistory eventHistory = EventHistory.builder().eventDescription(eventDescription).build();
      ...
      serviceUnderTest.assignCaseworker(
          expectedCaseworker.getId(), List.of(applicationId), eventHistory);
    ...
    void givenNullApplicationIdInList_whenAsssignCaseworker_thenThrowValidationException() {
      ...
      Throwable thrown =
          catchThrowable(
              () ->
                  serviceUnderTest.assignCaseworker(
                      expectedCaseworker.getId(), applicationIdsWithNull, new EventHistory()));
      assertThat(thrown)
          .isInstanceOf(ValidationException.class)
          .usingRecursiveComparison()
    ...
    void givenNonexistentCaseworker_whenAssignCaseworker_thenThrowResourceNotFoundException() {
      ...
      Throwable thrown =
          catchThrowable(
              () ->
                  serviceUnderTest.assignCaseworker(
                      nonexistentCaseworkerId, List.of(UUID.randomUUID()), new EventHistory()));
      assertThat(thrown)
    ...
    void givenEmptyApplicationIds_whenAssignCaseworker_thenNoActionTaken() {
      ...
      // when
      serviceUnderTest.assignCaseworker(
          expectedCaseworker.getId(), emptyApplicationIds, new EventHistory());
    ...
    void givenDuplicateApplicationIds_whenAssignCaseworker_thenOnlyDistinctIdsUsed()
      ...
      EventHistory eventHistory =
          EventHistory.builder().eventDescription("Caseworker assigned.").build();
    ...
    void givenMissingApplications_whenAssignCaseworker_thenThrowResourceNotFoundException() {
      ...
      EventHistory eventHistory = EventHistory.builder().eventDescription("Case assigned.").build();
      ...
      Throwable thrown =
          catchThrowable(
              () ->
                  serviceUnderTest.assignCaseworker(
                      expectedCaseworker.getId(), applicationIds, eventHistory));
      assertThat(thrown)
          .isInstanceOf(ResourceNotFoundException.class)
          .hasMessage(
    ...
    void givenRoleReader_whenAssignCaseworker_thenThrowUnauthorizedException() {
      ...
      Throwable thrown =
          catchThrowable(
              () ->
                  serviceUnderTest.assignCaseworker(
                      UUID.randomUUID(), List.of(UUID.randomUUID()), new EventHistory()));
      assertThat(thrown)
  ...
  class UnassignCaseworker {
    ...
    void givenAssignedCaseworker_whenUnassignCaseworker_thenUnassignAndSave(String eventDescription)
        throws JsonProcessingException {
      // given
      UUID applicationId = UUID.randomUUID();
      ...
      ApplicationEntity existingApplicationEntity =
          applicationEntityFactory.createDefault(
              builder -> builder.id(applicationId).caseworker(expectedCaseworker));

      ApplicationEntity expectedApplicationEntity =
          existingApplicationEntity.toBuilder().caseworker(null).build();
      ...
      when(applicationRepository.findById(applicationId))
          .thenReturn(Optional.of(existingApplicationEntity));
    ...
    void givenAlreadyUnassigned_whenUnassignCaseworker_thenNotSave()
      ...
      EventHistory eventHistory = EventHistory.builder().eventDescription("Unassigned").build();
    ...
    void givenNonexistentApplication_whenUnassignCaseworker_thenThrowResourceNotFoundException(
      ...
      Throwable thrown =
          catchThrowable(
              () -> serviceUnderTest.unassignCaseworker(applicationId, new EventHistory()));
      assertThat(thrown)
          .isInstanceOf(ResourceNotFoundException.class)
    ...
    void givenRoleReader_whenUnassignCaseworker_thenThrowUnauthorizedException() {
      ...
      Throwable thrown =
          catchThrowable(
              () -> serviceUnderTest.unassignCaseworker(UUID.randomUUID(), new EventHistory()));
      assertThat(thrown)
          .isInstanceOf(AuthorizationDeniedException.class)
          .hasMessage("Access Denied");
    ...
    private Stream<Arguments> invalidUnassignApplicationIdCases() {
      return Stream.of(Arguments.of(UUID.randomUUID()), Arguments.of((UUID) null));
    }
  }
  ...
  class ReassignCaseworker {
    ...
    void givenApplicationWithCaseworker_whenReassignCaseworker_thenSaveAndCreateDomainEvent()
      ...
      CaseworkerEntity existingCaseworker =
          caseworkerFactory.createDefault(
      ...
      EventHistory eventHistory =
          EventHistory.builder().eventDescription("Case reassigned.").build();
  ...
  private void assertIndividualCollectionsEqual(
      List<Individual> expectedList, Set<IndividualEntity> actualList) {
    ...
    for (Individual expected : expectedList) {
      ...
      assertThat(match).as("No matching IndividualEntity found for expected: " + expected).isTrue();
    }
  }
  ...
  private void verifyThatApplicationEntitySaved(
      ApplicationEntity expectedApplicationEntity, int timesCalled) {
    ArgumentCaptor<ApplicationEntity> captor = ArgumentCaptor.forClass(ApplicationEntity.class);
    verify(applicationRepository, times(timesCalled)).save(captor.capture());
    ApplicationEntity actualApplicationEntity = captor.getValue();
