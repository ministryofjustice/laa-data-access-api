...
class IndividualResponseMapperTest extends BaseMapperTest {
  ...
  @InjectMocks private IndividualMapperImpl individualMapper;
  ...
  void givenIndividualEntity_whenToExtendedIndividual_thenMapsFieldsCorrectly(
      ...
      Boolean appliedPreviously,
      List<Map<String, Object>> addresses) {
    IndividualEntity expectedIndividualEntity =
        IndividualEntity.builder().type(IndividualType.CLIENT).build();

    IndividualResponse actualIndividualResponse =
        individualMapper.toExtendedIndividual(
            expectedIndividualEntity,
            IndividualType.CLIENT,
            IncludedAdditionalData.CLIENT_DETAILS,
            getExtendedIndividualApplicationContent(
                lastName,
    ...
    assertThat(actualIndividualResponse.getCorrespondenceAddressType())
        .isEqualTo(correspondenceAddressType);
    assertThat(actualIndividualResponse.getLastNameAtBirth()).isEqualTo(lastName);
    assertThat(actualIndividualResponse.getPreviousApplicationId())
        .isEqualTo(previousApplicationId);
    assertThat(actualIndividualResponse.getRelationshipToInvolvedChildren())
  ...
  void givenIndividualWithAllNullFields_whenToIndividualEntity_thenAllFieldsAreNull() {
    IndividualResponse individualResponse =
        DataGenerator.createDefault(
            IndividualGenerator.class,
            builder ->
                builder.firstName(null).lastName(null).dateOfBirth(null).details(null).type(null));
