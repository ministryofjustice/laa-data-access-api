...
@Profile("unit-test")
@Component
public class MeritsDecisionsEntityFactory
    extends BaseFactory<MeritsDecisionEntity, MeritsDecisionEntity.MeritsDecisionEntityBuilder> {
  ...
  public MeritsDecisionEntity createDefault() {
    return MeritsDecisionEntity.builder().id(UUID.randomUUID()).build();
  }
}
