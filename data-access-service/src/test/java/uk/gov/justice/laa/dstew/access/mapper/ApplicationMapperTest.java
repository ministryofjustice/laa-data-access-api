...
class ApplicationMapperTest {
  ...
  void givenApplicationEntity_whenToApplication_thenMapsFieldsCorrectly() {
    ...
    assertThat(actualApplication.getCreatedAt())
        .isEqualTo(OffsetDateTime.ofInstant(createdAt, ZoneOffset.UTC));
    assertThat(actualApplication.getUpdatedAt())
  ...
  void givenApplicationEntityWithIndividuals_whenToApplication_thenMapsSetCorrectly() {
    ...
    Set<IndividualEntity> expectedIndividuals =
        Set.of(
            IndividualEntity.builder().id(id1).build(), IndividualEntity.builder().id(id2).build());
  ...
  void givenApplicationCreateRequest_whenToApplicationEntity_thenMapsFieldsCorrectly() {
    ...
    List<Individual> expectedIndividuals =
        List.of(Individual.builder().build(), Individual.builder().build());
  ...
  void
    ...
    ApplicationUpdateRequest req =
        new ApplicationUpdateRequest(); // all nulls except applicationContent
  ...
  void givenApplicationUpdateRequest_whenUpdateApplicationEntity_thenMapperUpdatesRelevantFields() {
    ...
    ApplicationUpdateRequest applicationUpdateRequest =
        ApplicationUpdateRequest.builder()
