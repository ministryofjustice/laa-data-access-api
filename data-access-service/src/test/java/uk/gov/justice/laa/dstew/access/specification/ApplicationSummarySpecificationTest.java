...
public class ApplicationSummarySpecificationTest {
  ...
  void givenAllEmpty_whenToPredicate_thenReturnNull() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(null, null, null, null, null);
  ...
  void givenReference_whenToPredicate_thenReturnPredicate() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(null, reference, null, null, null);
  ...
  void givenBlankReference_whenToPredicate_thenReturnNull() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(null, "", null, null, null);
  ...
  void givenApplicationStatus_whenToPredicate_thenReturnPredicate() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(
            ApplicationStatus.IN_PROGRESS, null, null, null, null);
  ...
  void givenFirstName_whenToPredicate_thenReturnPredicate() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(null, null, firstName, null, null);

    Predicate summaryPredicate = mock(Predicate.class);

    when(root.join(eq("individuals"), eq(JoinType.INNER))).thenReturn(mock());

    when(builder.like(any(), eq("%" + firstName + "%"))).thenReturn(summaryPredicate);
    Predicate result = spec.toPredicate(root, query, builder);
  ...
  void givenLastName_whenToPredicate_thenReturnPredicate() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(null, null, null, lastName, null);

    Predicate summaryPredicate = mock(Predicate.class);

    when(root.join(eq("individuals"), eq(JoinType.INNER))).thenReturn(mock());

    when(builder.like(any(), eq("%" + lastName + "%"))).thenReturn(summaryPredicate);
    Predicate result = spec.toPredicate(root, query, builder);
  ...
  void givenCaseworkerId_whenToPredicate_thenReturnPredicate() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(null, null, null, null, caseworkerId);

    Predicate summaryPredicate = mock(Predicate.class);
    when(root.join(eq("caseworker"), eq(JoinType.INNER))).thenReturn(mock());
  ...
  void givenAllFilters_whenToPredicate_thenReturnPredicate() {
    ...
    Specification<ApplicationSummaryEntity> spec =
        ApplicationSummarySpecification.filterBy(
            status, reference, firstName, lastName, caseworkerId);
