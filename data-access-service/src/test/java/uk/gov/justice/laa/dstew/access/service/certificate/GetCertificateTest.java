...
public class GetCertificateTest extends BaseServiceTest {
    ...
    @Autowired
    private CertificateService serviceUnderTest;

    @Test
    public void givenExistingCertificate_whenGetCertificate_thenReturnCertificateContent() {
        // given
        ApplicationEntity applicationEntity = DataGenerator.createDefault(ApplicationEntityGenerator.class);
        UUID applicationId = applicationEntity.getId();

        CertificateEntity certificateEntity = DataGenerator.createDefault(
