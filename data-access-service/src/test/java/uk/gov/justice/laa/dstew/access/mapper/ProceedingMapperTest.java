...
class ProceedingMapperTest extends BaseMapperTest {
  ...
  void givenNullProceeding_whenToProceedingEntity_thenReturnNull() {
    assertThat(
            proceedingMapper.toProceedingEntity(
                null, ApplicationEntity.builder().id(UUID.randomUUID()).build()))
        .isNull();
  }
  ...
  void givenProceedingWithAllNullFields_whenToProceedingEntity_thenNullableFieldsAreNull() {
    ...
    ProceedingEntity result =
        proceedingMapper.toProceedingEntity(proceeding, (ApplicationEntity) null);
