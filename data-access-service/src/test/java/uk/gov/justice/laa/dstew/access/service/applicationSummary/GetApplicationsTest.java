...
public class GetApplicationsTest extends BaseServiceTest {
    ...
    public void givenPageZeroAndNoFilters_whenGetApplications_thenReturnApplications(int count) {
        // given
        List<ApplicationSummary> expectedApplications = applicationSummaryFactory.createMultipleRandom(count);
        Page<ApplicationSummary> pageResult = new PageImpl<>(expectedApplications);
        ...
        when(applicationRepository.findApplicationSummaries(any(Specification.class), any(Pageable.class))).thenReturn(pageResult);
        ...
        // then
        verify(applicationRepository, times(1)).findApplicationSummaries(any(Specification.class), any(Pageable.class));
    ...
    public void givenPageZeroAndCaseworkerFound_whenGetApplications_thenReturnApplications(int count) {
        ...
        if (count > 0) { expectedApplications.getFirst().setAssignedTo(null); }
    ...
    public void givenPageZeroAndUserId_whenGetApplicationsAndNoCaseworkerFound_thenThrowValidationException() {
        ...
        verify(applicationRepository, never()).findApplicationSummaries(any(Specification.class), any(Pageable.class));
    }
