...
import static uk.gov.justice.laa.dstew.access.service.applications.sharedAsserts.DomainEvent.verifyThatDomainEventSaved;
...
public class MakeDecisionForApplicationTest extends BaseServiceTest {
  ...
  void givenMissingEntity_whenMakeDecision_thenThrowResourceNotFoundException(
    ...
    // save() is called before proceeding lookup, so only assert never-saved for early-exit
    // scenarios
