...
public class ApplicationFactoryImpl
    implements Factory<ApplicationEntity, ApplicationEntity.ApplicationEntityBuilder> {
  ...
  public ApplicationEntity create() {
    ...
    IndividualEntity individualEntity =
        IndividualEntity.builder()
            ...
            .individualContent(new LinkedHashMap<>(Map.of("test", "content")))
            .build();
    ...
    return ApplicationEntity.builder()
        ...
        .applicationContent(new LinkedHashMap<>(Map.of("test", "content")))
