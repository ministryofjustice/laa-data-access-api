...
public class TestConfiguration {
  ...
  public PersistedFactory<
          ...
          UUID>
      persistedProceedingFactory(
          ProceedingRepository repository,
          Factory<ProceedingEntity, ProceedingEntity.ProceedingEntityBuilder> proceedingFactory) {
  ...
  public PersistedFactory<
          ...
          UUID>
      persistedMeritsDecisionFactory(
          MeritsDecisionRepository repository,
          Factory<MeritsDecisionEntity, MeritsDecisionEntity.MeritsDecisionEntityBuilder>
              meritsDecisionFactory) {
  ...
  public PersistedFactory<
          ...
          UUID>
      persistedDecisionFactory(
          DecisionRepository repository,
          Factory<DecisionEntity, DecisionEntity.DecisionEntityBuilder> decisionFactory) {
  ...
  @Bean
  public Factory<IndividualEntity, IndividualEntity.IndividualEntityBuilder>
      individualEntityFactory() {
  ...
  @Bean
  public Factory<MakeDecisionRequest, MakeDecisionRequest.Builder>
      applicationMakeDecisionRequestFactory() {
  ...
  @Bean
  public Factory<MeritsDecisionEntity, MeritsDecisionEntity.MeritsDecisionEntityBuilder>
      meritsDecisionFactory() {
  ...
  @Bean
  public Factory<LinkedApplicationEntity, LinkedApplicationEntity.LinkedApplicationEntityBuilder>
      linkedApplicationEntityFactory() {
