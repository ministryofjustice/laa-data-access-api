...
public class ApplicationTest extends BaseIntegrationTest {
  ...
  class CreateApplication {
    ...
    public void givenInvalidApplicationRequestData_whenCreateApplication_thenReturnBadRequest(
        ApplicationCreateRequest request, ProblemDetail expectedDetail) throws Exception {
      // when
    ...
    public void givenInvalidApplicationContent_whenCreateApplication_thenReturnBadRequest()
      ...
      ValidationException expectedValidationException =
          ValidationExceptionBuilder.create()
      ...
      assertValidationException(
          ...
          expectedValidationException.errors(),
          result,
          validationException);
      assertEquals(0, applicationRepository.count());
    }
    ...
    private void assertApplicationEqual(
        ApplicationCreateRequest expected, ApplicationEntity actual) {
  ...
  class GetApplications {
      ...
      List<ApplicationSummary> expectedApplicationsSummary =
          persistedApplicationFactory
              .createAndPersistMultiple(
                  ...
                  builder ->
                      builder.individuals(
                          Set.of(individualFactory.create(i -> i.firstName(persistedFirstName)))))
              .stream()
              .map(this::createApplicationSummary)
              .toList();
      ...
      List<ApplicationSummary> expectedApplicationsSummary =
          persistedApplicationFactory
              .createAndPersistMultiple(
                  ...
                  builder ->
                      builder.individuals(
                          Set.of(individualFactory.create(i -> i.lastName(persistedLastName)))))
              .stream()
              .map(this::createApplicationSummary)
              .toList();
    ...
    void
      ...
      persistedApplicationFactory.createAndPersistMultiple(
          ...
          builder ->
              builder.individuals(
                  Set.of(individualFactory.create(i -> i.firstName("George").lastName("Taylor")))));
      List<ApplicationSummary> expectedApplicationsSummary =
          persistedApplicationFactory
              .createAndPersistMultiple(
                  2,
    ...
    void
      ...
      persistedApplicationFactory.createAndPersistMultiple(
          ...
          builder ->
              builder.individuals(
                  Set.of(individualFactory.create(i -> i.firstName("Lucas").lastName("Jones")))));
      persistedApplicationFactory.createAndPersistMultiple(
          5,
          builder ->
              builder.individuals(
      ...
      persistedApplicationFactory.createAndPersistMultiple(
          ...
          builder ->
              builder
                  ...
                  .individuals(
                      Set.of(
                          individualFactory.create(i -> i.firstName("Lucas").lastName("Jones")))));
      persistedApplicationFactory.createAndPersistMultiple(
          5,
          builder ->
              builder.individuals(
