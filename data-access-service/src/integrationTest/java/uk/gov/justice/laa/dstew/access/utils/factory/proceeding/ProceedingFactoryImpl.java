...
public class ProceedingFactoryImpl
    implements Factory<ProceedingEntity, ProceedingEntity.ProceedingEntityBuilder> {
  ...
  public ProceedingEntity create() {
    return ProceedingEntity.builder()
        ...
        .proceedingContent(new HashMap<>(Map.of("test", "content")))
        .build();
  }
