...
public class GetCaseworkersTest extends BaseIntegrationTest {
  ...
  private void assertCaseworkerListEquals(
      List<CaseworkerResponse> caseworkerResponses, List<CaseworkerEntity> entities) {
  ...
  private void assertCaseworkerEquals(
      CaseworkerResponse caseworkerResponse, CaseworkerEntity entity) {
