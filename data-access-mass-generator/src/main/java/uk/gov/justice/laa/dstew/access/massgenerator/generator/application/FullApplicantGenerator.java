...
public class FullApplicantGenerator extends BaseGenerator<FullApplicant, FullApplicant.FullApplicantBuilder> {

    private final FullApplicantAddressGenerator addressGenerator = new FullApplicantAddressGenerator();
