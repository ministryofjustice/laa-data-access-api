...
public class FullLegalFrameworkMeritsTaskListGenerator extends BaseGenerator<FullLegalFrameworkMeritsTaskList, FullLegalFrameworkMeritsTaskList.FullLegalFrameworkMeritsTaskListBuilder> {
    ...
    public FullLegalFrameworkMeritsTaskListGenerator() {
        super(FullLegalFrameworkMeritsTaskList::toBuilder, FullLegalFrameworkMeritsTaskList.FullLegalFrameworkMeritsTaskListBuilder::build);
    }
