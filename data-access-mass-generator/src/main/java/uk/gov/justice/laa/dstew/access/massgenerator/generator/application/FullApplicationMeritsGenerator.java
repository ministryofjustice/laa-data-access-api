...
public class FullApplicationMeritsGenerator extends BaseGenerator<ApplicationMerits, ApplicationMerits.ApplicationMeritsBuilder> {

    private final FullOpponentDetailsGenerator opponentDetailsGenerator = new FullOpponentDetailsGenerator();
