...
public class FullJsonGenerator extends BaseGenerator<ApplicationContent, ApplicationContent.ApplicationContentBuilder> {
    ...
    private final FullBenefitCheckResultGenerator benefitCheckResultGenerator = new FullBenefitCheckResultGenerator();
    private final FullLegalFrameworkMeritsTaskListGenerator legalFrameworkMeritsTaskListGenerator = new FullLegalFrameworkMeritsTaskListGenerator();
    ...
    private final FullApplicationMeritsGenerator applicationMeritsGenerator = new FullApplicationMeritsGenerator();
    private final FullProceedingGenerator proceedingGenerator = new FullProceedingGenerator();
    private final FullProceedingMeritsGenerator proceedingMeritsGenerator = new FullProceedingMeritsGenerator();
...
//                .previousApplicationReference(faker.regexify("[A-Z]{2}[0-9]{3}[A-Z]"))
                ...
                .build()
                .putAdditionalApplicationContent("applicationRef", faker.regexify("L-[A-Z]{3}-[A-Z][0-9]{2}-[0-9]"))
                ...
                .putAdditionalApplicationContent("providerStep", faker.options().option("submitted_applications", "provider_details"))
                ...
                .putAdditionalApplicationContent("reviewed", Map.of(
                        "checkProviderAnswers", Map.of("status", "completed", "at", randomInstant())))
                ...
                .putAdditionalApplicationContent("benefitCheckResult", benefitCheckResultGenerator.createDefault())
                .putAdditionalApplicationContent("dwpOverride", null)
                .putAdditionalApplicationContent("legalFrameworkMeritsTaskList", legalFrameworkMeritsTaskListGenerator.createDefault())
                ...
                .putAdditionalApplicationContent("proceedingMerits", List.of(
